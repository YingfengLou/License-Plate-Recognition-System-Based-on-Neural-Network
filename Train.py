...
if __name__ == '__main__':
    ...
    char_model_path = os.path.join(cur_dir,'./carIdentityData/model/char_recongnize/model.ckpt-560.meta')
    img = cv2.imread('F:/biyesheji\DesignLou\carIdentityData\pictures/1.jpg')
